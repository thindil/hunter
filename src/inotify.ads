...
private
   ...
   for Event_Kind use (Accessed => 16#0001#, Modified => 16#0002#,
   ...
   All_Events: constant Watch_Bits :=
     (Accessed | Modified | Metadata | Closed_Write | Closed_No_Write |
      Opened | Moved_From | Moved_To | Created | Deleted | Deleted_Self |
      Moved_Self =>
        True,
      others => False);
...
-----------------------------------------------------------------------------
   ...
   package Watch_Maps is new Ada.Containers.Indefinite_Hashed_Maps
     (Key_Type => Interfaces.C.int, Element_Type => String, Hash => Hash,
